...
export const StyleSwitcher: React.FC = () => {
  ...
  return (
    <div className="relative">
      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-64 p-2 bg-base-200 rounded shadow-xl z-50">
          <div className="space-y-1">
            {styles.map((style) => (
              <button
                ...
                className={`w-full p-2 text-left hover:bg-base-300 rounded transition-colors flex flex-col
